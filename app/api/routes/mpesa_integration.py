...
def add_mpesa_payment(
    ...
    try:
        ...
        # Tenant should only have 1 active payment at a time
...
async def test_mpesa_integration(
    ...
    try:
        ...
        print(integration.consumer_key)
        ...
        async with httpx.AsyncClient() as client:
            ...
            # {"message": "M-PESA Integration test failed", "response": resp_json})
...
async def mpesa_callback(
    ...
    try:
        ...
        print("MPESA Callback Payload: ", json.dumps(body, indent=2))
        # Extract core details from mpesa response
        ...
        # Get metadata values if transaction was successful
        if result_code == 0:
            ...
            if donation:
                ...
                print("Donation not found for this transaction")
            print("✅ Payment Success")
            print("Amount:", amount)
            print("Receipt:", mpesa_receipt_number)
            ...
            if donation:
                ...
                print("Donation not found for this transaction: Save to untracked payments")

        return {"message": "Callback received"}, 200

    except Exception as e:
        print("Callback parsing failed:", e)
